...
import { ContextPlate } from "./context-plate";
    ...
    <div className="w-full max-w-4xl space-y-8">
      <div className="relative mx-auto max-w-2xl space-y-4">
        <div className="relative flex items-center">
          ...
          <Input
            className="bg-background/50 focus-visible:ring-primary/20 h-14 rounded-full border-2 pr-32 pl-12 text-lg shadow-lg backdrop-blur-sm"
      ...
      <div className="min-h-[100px]">
                ...
                >
                  <CardContent className="relative p-5">
                    ...
                    <div className="pr-8">
                      ...
                      <Button
                        className="text-muted-foreground hover:bg-primary/10 hover:text-primary mt-4 h-8 w-full justify-start px-2 transition-colors"
                        onClick={(e) => {
                          e.stopPropagation();
        ...
        {foods && foods.length === 0 && debouncedQuery && !isLoading && (
          <div className="text-muted-foreground flex flex-col items-center justify-center rounded-2xl border-2 border-dashed py-12 text-center">
